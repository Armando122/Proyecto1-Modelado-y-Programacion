...
def impresion(dicionario):
    #Primero se verifica que el diccionario no sea vacío
    if not is_empty(diccionario):
        ...
        for ciudad in diccionario:
            ...
            #Se verifica que exista infirmación sobre el clima.
            if not is_empty(clima):
                ...
                #Si no hay información del clima, se le avisa al usuario y se
                #continua con la siguiente ciudad.
                print("No hay clima disponible para " + ciudad)
                continue
    else:
        #Si el diccionario está vacío, se le avisa al usuario.
